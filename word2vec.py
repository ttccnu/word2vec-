...
def train_word2vec(filenames):
    ...
    model.wv.save_word2vec_format("D:\python project\multimodal_emotion/text_rnn\data/vector_word.txt",
                                  binary=False)
    print('-------------------------------------------')
...
if __name__ == '__main__':
    ...
    filenames=["D:\python project\multimodal_emotion/text_rnn\datasets\cnews.train.txt",
               "D:\python project\multimodal_emotion/text_rnn\datasets\cnews.test.txt",
               "D:\python project\multimodal_emotion/text_rnn\datasets\cnews.val.txt"]
